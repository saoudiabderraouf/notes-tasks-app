...
class TasksAdapter(val context: Context, var data: ArrayList<Task>, var dbHandler: DBHandler) :
    RecyclerView.Adapter<TasksAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(context).inflate(R.layout._row_task, parent, false)
        )
    }
